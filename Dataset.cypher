...
//RELATION REVIEWED
(LanaW)-[:REVIEWED {rating: 5, summary: 'Sản phẩm không tươi ngon'}]->(LillyW),
(LanaW)-[:REVIEWED {rating: 5, summary: 'Giá cả hợp lí'}]->(Hugo),
(LanaW)-[:REVIEWED {rating: 2, summary: 'Sản phảm không tươi ngon'}]->(RonH),
(JoelS)-[:REVIEWED {rating: 2, summary: 'Sản phẩm không tươi ngon'}]->(LillyW),
(JoelS)-[:REVIEWED {rating: 5, summary: 'Sản phảm xanh sạch'}]->(ClintE),
(JoelS)-[:REVIEWED {rating: 4, summary: 'Hài lòng'}]->(CameronC),
(JessicaThompson)-[:REVIEWED {rating: 3, summary: 'Tạm chấp nhận'}]->(StefanArndt),
(JessicaThompson)-[:REVIEWED {rating:1, summary:'Sản phẩm không đạt chất lượng'}]->(Howard),
(JessicaThompson)-[:REVIEWED {rating:2, summary:''}]->(ClintE),
(JessicaThompson)-[:REVIEWED {rating:1, summary:'Không phản hồi'}]->(MikeN),
(JessicaThompson)-[:REVIEWED {rating:5, summary:'Sản phẩm xanh sạch'}]->(RonH),
(JessicaThompson)-[:REVIEWED {rating:2, summary:'Sản phẩm kém chất lượng'}]->(CameronC),
(JamesThompson)-[:REVIEWED {rating:2, summary:''}]->(Howard),
(JamesThompson)-[:REVIEWED {rating:1, summary:'Sản phẩm bị hư'}]->(Keanu),
(JamesThompson)-[:REVIEWED {rating:1, summary:'Sản phẩm bị hư'}]->(RonH),
(AngelaScope)-[:REVIEWED {rating:2, summary:'Giao hàng chậm trễ'}]->(LillyW),
(AngelaScope)-[:REVIEWED {rating:2, summary:'Sản phẩm không đúng mô tả'}]->(Howard);
